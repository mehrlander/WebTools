...
| `untracked-file-invisible-to-the-suite` **×2** | 2026-08-29 | a local green over a file the scanner never enumerated |
...
on nothing you changed since. *(seen: 2026-08-28, 2026-08-29)*

The second sighting was one day later and identical in shape: a new
`docs/aims.json` carrying a field name the vocabulary did not account for,
`npm test` green at 2804/0 locally, red on the first push. Reading this entry
would have cost nothing and it was not read.
