...
**57 snags**, repeats first. Read this before adding one: a trip that is
...
| `untracked-file-invisible-to-the-suite` | 2026-08-28 | a local green over a file the scanner never enumerated |
...
on nothing you changed since. *(seen: 2026-08-28)*
