...
with a slug so a repeat can be matched and counted, which the older bold-lead
blocks in the tail do not: the generator reports how many sightings sit in that
shape and cannot be counted.)*

---

[//]: # (snags-index)

**20 snags**, repeats first. Read this before adding one: a trip that is
