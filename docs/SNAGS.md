...
**39 snags**, repeats first. Read this before adding one: a trip that is
...
| --- | --- | --- |
| `status-audit-skipped-index` **×9** | 2026-08-11 | the status audit silently dropped every marker in a file named `index.md` |
...
## `npm run showing` reads commits, so staged-but-uncommitted work reads as nothing (2026-08-22)
