...
const NOTES = {
  ...
  'transform.html':            'Multi-tab rows ⇒ rows workbench: $name refs, worker run, profile view, gz bundles. The standalone face of lib/alpineComponents/transform-workbench.js.',
