...
- 🎫 Two gaps the proposal channel showed on first use next: the removal kind landed; what remains is the put-file diff pane (extract diffLines from stage.js to lib/) and the applied record's commit link
