...
[`docs/properties.json`](docs/properties.json) in the same commit. The count
and where each renders live in show-repo's Map view, Registries tab. The model, the rules, and what its
