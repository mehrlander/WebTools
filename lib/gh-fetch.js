(() => {
  ...
  // anything; it is a per-branch census printed as if it were a fault, and it
  ...
  //
  // No body, deliberately. The open read carries bodies because the guide pane
  // renders one; carrying them for a hundred closed PRs would multiply the
  // activity cache by the size of its own history for a field nothing reads.
  //
