        ...
        h('div', { class: 'flex items-center gap-2.5' },
          ...
          h('div', { class: 'min-w-0 flex-1' },
            ...
            h('div', { class: 'mt-1 flex flex-wrap items-center gap-x-2.5 gap-y-1' },
              ...
              expand,
              card.ran ? h('span', { class: 'font-mono text-xs text-base-content/55 truncate' }, card.ran) : '')),
          go),
        turnBox));
    });
    ...
    function turnRow(t, i) {
      ...
      const body = h('div', { class: 'min-w-0 flex-1' },
        h('div', { class: 'flex items-baseline gap-2' },
          ...
          h('span', { class: 'font-mono text-[11px] text-base-content/45' }, t.ts || '')),
        h('div', {
          class: 'text-[13px] leading-relaxed text-base-content/65 '
