  ...
  function index(record, opts = {}) {
    ...
    line.forEach((card, ci) => {
      ...
      const go = opts.onOpen ? h('button', {
        class: 'btn btn-ghost btn-sm btn-circle shrink-0 -mr-1 text-base-content/35 hover:text-primary',
      ...
      list.append(h('div', {
        class: 'mb-1 border-l-2 py-3 pl-3 pr-2.5 ' + (RULE[card.kind] || RULE.work),
      },
