...
//            markdown rather than rendered text, and the only one raised from
//            outside this kit: kits/md-doc.js's section menu calls
//            noteSection(), since the heading is the one thing that knows
...
(() => {
  ...
  const noteSection = (headEl) => {
    ...
    const target = {
      type: 'section',
      selector: cssPath(headEl, S.doc.body),
      label: headingTrail(headEl),
