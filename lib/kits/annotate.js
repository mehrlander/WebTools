...
(() => {
  ...
  const mountUI = () => {
    ...
    S.aimBtn = el('button', 'box-sizing:border-box;min-height:30px;min-width:30px;margin-left:auto;'
      + 'display:flex;align-items:center;gap:3px;padding:2px 6px;background-color:#fff;'
