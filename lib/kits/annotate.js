...
(() => {
  ...
  const mountUI = () => {
    ...
    S.compose.appendChild(S.compPunct);
    S.compose.appendChild(S.compView);
  ...
  const paintDraft = () => {
    ...
    // the keyboard carries its own punctuation, so typing mode hides it.
    S.compPunct.style.display = S.editing ? 'none' : 'flex';
    ...
    setTimeout(() => {
      ...
      selBtn.addEventListener('click', () => {
        ...
        beginDraft({ type: 'text', quote: q, display,
                     selector: block ? cssPath(block, d.body) : '',
