...
(() => {
  ...
  const mountUI = () => {
    ...
    const head = el('div', 'display:flex;align-items:center;gap:6px;flex-wrap:wrap;padding:6px 8px 5px;'
    ...
    S.reviewBtn = el('button', 'border:1px solid #e4e4e7;background:#fff;border-radius:7px;'
      + 'padding:2px 8px;font:700 13px ui-sans-serif,system-ui;color:#18181b;cursor:pointer;');
    ...
    const chip = (label, title, fn) => {
      const b = el('button', 'border:0;background:#fff;color:#3f3f46;'
    ...
    const CBTN = key() + 'min-height:36px;';
