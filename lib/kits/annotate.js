...
(() => {
  ...
  const mountUI = () => {
    ...
    S.compHint = el('span', 'color:#a1a1aa;', 'Listening. Double-tap to type instead.');
    S.compBody = el('span', '');
  ...
  const paintDraft = () => {
    ...
    S.compHint.textContent = !S.dict ? 'Double-tap to type.'
      : S.dict.listening ? 'Listening. Double-tap to type instead.'
