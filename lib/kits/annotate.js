...
(() => {
  ...
  const renderList = () => {
    ...
    S.items.forEach((it, i) => {
      ...
      const acts = el('div', 'display:flex;flex-direction:column;gap:2px;');
      const pencil = icon('pencil-simple', 'border:0;background:none;color:#a1a1aa;cursor:pointer;'
        + 'padding:1px 2px;display:flex;', 'Edit this note');
