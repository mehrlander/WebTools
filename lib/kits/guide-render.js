...
/* A phone reads the guide at body size, not caption size: the 14px scale that
   ...
   takeover, and it read small. The drawer modifier stays put, since the FAB
   drawer is a desktop surface. */
@media (max-width:640px){
  .guide-body:not(.guide-body-sm){font-size:1rem}
  .guide-body:not(.guide-body-sm) code,.guide-body:not(.guide-body-sm) pre,
  .guide-body:not(.guide-body-sm) table{font-size:.875rem}
  .guide-body:not(.guide-body-sm) h1{font-size:1.125rem}
  .guide-body:not(.guide-body-sm) h2,.guide-body:not(.guide-body-sm) h3{font-size:1rem}
}
`;
