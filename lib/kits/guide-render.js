...
/* A wide table scrolls rather than widening the body. display:block is the
   ...
   stretched; the :not() hands the job over rather than doing it twice. One
   owner per table, decided by which one got there.
   (No backticks in here: this block lives inside a template literal.) */
.guide-body :not([data-md-scroll])>table{display:block;overflow-x:auto}
.guide-body table{font-size:.75rem;border-collapse:collapse}
