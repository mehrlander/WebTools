...
(() => {
  ...
  function open(o = {}) {
    ...
    const opts = {
      ...
      subtitle: [o.subtitle, at(start).dir].filter(Boolean).join(' · '),
    ...
    handle.deck.onSlide((i) => {
      ...
      const crumb = [o.parent ? o.parent.title : null, o.subtitle, dir].filter(Boolean).join(' · ');
