...
${opts.nested ? '' : `
    ...
    return {
      ...
      // Both are CARD notes, standing above the first turn and indented to line
      // up with the turn text below. A note about one TURN is no longer one of
      // these: `dropped` rides on the turn and chat-render puts it on the last
      // line of that turn's own text.
      //
      ...
      _replyFoot(text){
        ...
        el.className = 'text-[10px] text-base-content/60 leading-snug pl-4 mb-2';
        el.textContent = '… ' + text;
        return el;
      },
