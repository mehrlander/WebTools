      ...
      template: `
        <div>
          ...
          <!-- ── Activity pill row ─────────────────────────────────────────
               ...
               The pill runs at EVERY breakpoint, and used to be the
               narrow-screen form only: on lg+ the trio rendered side by side,
               Open the main column and To-do + Jots a 24rem right rail. That
               rail held its width whether or not either list had anything in
               it, which is a standing claim on the page's one scarce axis for
               two short lists that are read on purpose rather than watched.
               One tab at full width, at any size, is the same trade the phone
               was already making, and the counts on the pills keep the piles
          ...
          <!-- ── Activity composite ────────────────────────────────────────
               One container for the trio: the pill row above picks which pane
               ...
               'hidden' toggle on lg+ and rendered all three at once; see the
          ...
          <!-- ── To-do view (Activity sub-tab) ─────────────────────────────
               ...
               max-w-xl, not the pane's full width: it holds the list at a
               readable measure now that it is no longer boxed into a rail,
               and a one-line to-do stretched across a wide screen reads
               worse than the same line stopped at a column. -->
          <div class="max-w-xl" :class="tab==='todo' ? '' : 'hidden'">
            <p x-show="!authed" class="text-base text-base-content/60">
          ...
          <div class="max-w-xl" :class="tab==='jots' ? '' : 'hidden'">
            <p x-show="!authed" class="text-base text-base-content/60">
