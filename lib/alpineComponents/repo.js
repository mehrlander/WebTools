            ...
            <div class="flex-1 min-h-0 px-4 pb-2 flex flex-col">
              ...
              <div x-show="!dlg.loading && dlg.estate" class="flex-1 min-h-0 overflow-y-auto flex flex-col gap-3 pt-1">
                ...
                <div x-show="auth" class="flex flex-col gap-1">
                  ...
                  <div class="text-[13px] text-base-content/40 px-1">
    ...
    return {
      ...
      template: (inline ? `
        <!-- Headless in show-repo's header: the component is the repo/auth
             ...
             show-repo's sidebar, so a header copy was redundant; the header auth
             shield opens the dialog via __repo.openDialog(). -->`
      : `
