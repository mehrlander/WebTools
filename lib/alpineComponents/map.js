...
// Under ?use= Pages still serves the page file from main, so a ref has to go
      ...
      // to a 2 KB preview since 2026-08-07. The label now says what it cannot
      // see rather than what it trusts.
      docReadLabel(d){
