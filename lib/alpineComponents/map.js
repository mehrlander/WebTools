                    ...
                    <div class="mb-4">
                      ...
                      <div class="relative h-7 mt-1.5 rounded bg-base-200">
                        <div class="absolute inset-y-0 left-0 rounded"
                             ...
                             :style="'width:' + injPct(c.total) + '%'"></div>
                        <div x-show="c.cap" class="absolute inset-y-0 w-0.5 bg-error"
                             :style="'left:' + injPct(c.cap) + '%'"></div>
                      </div>
                      <div class="flex flex-wrap gap-x-3 mt-1" x-show="c.contributors.length">
                        <template x-for="k in c.contributors" :key="k.script">
                          <span class="text-base text-base-content/50">
                            <span x-text="k.script"></span>
                            <span class="font-mono" x-text="k.bytes.toLocaleString()"></span>
                          </span>
                        </template>
                      </div>
                    </div>
