document.addEventListener('alpine:init', function() {
  Alpine.data('map', function() {
    ...
    const KIND_ORDER = ['gate', 'tool', 'kit', 'behavior', 'component', 'guard'];
    ...
    const KIND_TONE = {
      gate: 'badge-success', tool: 'badge-info',
