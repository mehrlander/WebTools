              ...
              <div class="flex flex-col gap-8 max-w-4xl">
                ...
                <div x-show="injection.observed">
                  ...
                  <div class="flex flex-wrap items-baseline gap-x-4 gap-y-1 mb-3">
                    <span class="text-base" x-text="injection.observed?.sessions + ' recorded sessions'"></span>
                    <span class="text-base text-base-content/50"
                          x-text="injection.observed?.from + ' to ' + injection.observed?.to"></span>
                    <span class="text-base text-base-content/50"
                          x-text="'of ' + injection.observed?.scanned + ' records'"></span>
                    <code class="text-[11px] font-mono opacity-40" x-text="injection.observed?.store"></code>
                  </div>
                  <div class="flex flex-col gap-1.5">
                    <template x-for="o in (injection.observed?.documents || [])" :key="o.via + o.path">
                    ...
                    <div class="border border-warning/60 rounded-lg px-3 py-2 bg-base-100 flex items-baseline gap-2 flex-wrap">
                      ...
                      <div class="grow"></div>
                      <span class="text-base font-mono text-base-content/60"
                            x-text="injection.observed?.both_channels + ' of ' + injection.observed?.sessions"></span>
                    </div>
                  </div>
                </div>

                <div x-show="!injection.observed" class="text-base text-base-content/50">
                  No session store checked out, so this container's reading is the only evidence here.
                </div>
