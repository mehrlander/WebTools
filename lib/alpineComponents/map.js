        ...
        <div class="w-full">
          ...
          <section x-show="mapTab==='registries'">
            ...
            <p class="text-sm text-base-content/50 mb-5 max-w-4xl">
              What governs each committed carrier in the repo. A registry names its carrier, the
              target grain it asserts about, the population it covers, and the gate that holds it.
              A declaration binds one property to one registry, says whether it is recorded or
              computed, and how hard the gate enforces it.
            </p>
            ...
            <template x-if="propsReg">
              <div class="max-w-4xl">
                ...
                <div class="flex flex-col gap-3">
                  <template x-for="r in registryRows" :key="r.id">
                    <div class="border border-base-300 rounded-lg p-3 bg-base-100">
                      <div class="flex items-baseline gap-2 flex-wrap">
                        <span class="font-semibold" x-text="r.id"></span>
                      ...
                      <p class="text-base text-base-content/70 mt-1">
                        <span class="font-semibold text-base-content/50">asserts about</span> <span x-text="r.target"></span></p>
