        ...
        <div class="w-full">
          ...
          <section x-show="mapTab==='registries'">
            ...
            <p class="text-sm text-base-content/50 mb-5 max-w-4xl">
              ...
              list: since 2026-08-16 the index governs itself, so every closed column carries a
              declared value domain rather than a list held in a test. There are no species of
              registry, only facts about one: membership says whether the rows can be recomputed,
              and inherits names the registry whose descriptions this one borrows. Where each
              registry renders is derived from
