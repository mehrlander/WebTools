...
${regChip('SURF_MANIFEST')}
          ...
          <section x-show="mapTab==='showing'">
            <!-- Four files meet in this header and the reader has to be able
                 ...
                 the rows: showing-mechanisms, routes-modes, routes-routes. And
                 docs/routes.json, faint at the end, is neither: it holds the
                 tab's configuration and prose frame (note, hub, renderer,
                 precedence, grammar) and no rows at all, which is why it has no
                 row in docs/registries.csv and no chip here. It carried the
                 lone Curate button until 2026-08-26, so the one file the button
                 opened was the one file holding almost nothing on screen. -->
            <div class="flex items-center gap-2 mb-5 flex-wrap">
