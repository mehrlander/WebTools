document.addEventListener('alpine:init', function() {
  Alpine.data('map', function() {
    ...
    const REACH = {
      ...
      project: { label: 'by CLAUDE.md', tone: 'badge-secondary', hint:
        'Named by the repo\'s own CLAUDE.md, which every session reads, so it is one hop away and needs no invocation.' },
