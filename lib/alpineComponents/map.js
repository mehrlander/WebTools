document.addEventListener('alpine:init', function() {
  Alpine.data('map', function() {
    ...
    //               docs/docs.json: every doc's subject, status (living or
    //               record), and maintenance, plus the shared-claims table
    //               (each repeated statement's one authoritative carrier, its
