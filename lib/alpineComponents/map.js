                          ...
                          <div class="min-w-0 flex-1">
                            <div class="flex items-center gap-2 flex-wrap">
                              ...
                              <!-- Readership: distinct sessions that opened
                                   this file (main's parallel work, grafted
                                   into the rail row at the merge). Absent
                                   entirely without a token, since the count
                                   lives in the private registry and an empty
                                   column would read as "nobody opened it". -->
