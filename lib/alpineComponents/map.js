document.addEventListener('alpine:init', function() {
  Alpine.data('map', function() {
    ...
    //               as a peer of docs and hid the hierarchy. Reach is the one field here that is
