        ...
        <div :style="'transform:translate(' + x + 'px,' + y + 'px)'"
          ...
          <div x-show="fabMenu" x-cloak x-transition.opacity.duration.120ms
            ...
            <div class="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-base-200">
              ...
              <div class="ml-auto flex gap-0.5">
                <button @click="fabMenu = false; annAim('page')" aria-label="Note the page"
                        class="btn btn-ghost btn-xs btn-square" title="the page">
                  <i class="ph ph-file text-[16px] text-primary"></i>
                </button>
                <button @click="fabMenu = false; annAim('pick')" aria-label="Note an element"
                        class="btn btn-ghost btn-xs btn-square" title="an element">
                  <i class="ph ph-crosshair-simple text-[16px] text-primary"></i>
                </button>
                <button x-show="annKind" @click="fabMenu = false; annAim('section')"
                  ...
                  <i class="ph ph-text-align-left text-[16px] text-primary"></i>
                </button>
                <button @click="fabMenu = false; annAim('region')" aria-label="Note a region"
                        class="btn btn-ghost btn-xs btn-square" title="a region">
                  <i class="ph ph-frame-corners text-[16px] text-primary"></i>
                </button>
              </div>
            </div>
            ...
            <button @click="fabMenu = false; openPeek()"
              ...
              <i class="ph ph-crosshair text-[15px] text-primary"></i>
