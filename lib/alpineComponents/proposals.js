              ...
              <div class="card bg-base-100 border border-base-300 shadow-sm">
                <div class="p-3 sm:p-4 flex flex-col gap-2">
                  ...
                  <div class="flex items-start gap-2 flex-wrap">
                    ...
                    <div class="grow"></div>
                    <span class="badge badge-ghost badge-sm font-mono" x-text="p.kind"></span>
                  </div>
                  ...
                  <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <button x-show="confirming === p.id && applying !== p.id"
                      ...
                      <i class="ph ph-warning"></i><span x-text="'Write to ' + p.repo + '?'"></span>
                    </button>
                    <button x-show="confirming === p.id && applying !== p.id"
      ...
      async load() {
        ...
        try {
          ...
          for (const name of names) {
            ...
            row.targetGh = 'https://github.com/' + rec.repo + '/blob/HEAD/' + rec.path;
            ...
            else Object.assign(row, { resolved: true, exists: r.exists, before: r.before, after: r.after, fieldBefore: r.fieldBefore });
            rows.push(row);
          }
          this.items = rows;
        } catch (e) {
