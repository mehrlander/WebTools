            ...
            <div class="flex flex-col gap-2"
              ...
              <div x-show="!loading" class="flex items-center gap-1">
                ...
                <!-- What the comparison is against, and how to change it. The
                     ...
                     (No backticks in this markup: it is a JS template literal.) -->
                <details class="dropdown dropdown-end shrink-0" x-ref="cmpMenu" x-show="comparePicker">
                  <summary class="btn btn-ghost btn-xs gap-1 cursor-pointer font-normal"
                ...
                <details class="dropdown dropdown-end shrink-0" x-ref="ghMenu">
                  <summary class="btn btn-ghost btn-xs gap-0.5 cursor-pointer"
                    ...
                    <i class="ph text-base" :class="read ? 'ph-dots-three-vertical' : 'ph-github-logo'"></i>
