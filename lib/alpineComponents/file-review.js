          ...
          <div x-show="open" x-collapse>
            ...
            <div class="flex flex-col gap-2"
              ...
              <div x-show="!loading" class="flex items-center gap-1">
                ...
                <div class="order-3 grow" x-show="read"></div>
                ...
                <!-- What the comparison is against, and how to change it. The
                     ...
                     (No backticks in this markup: it is a JS template literal.) -->
                <details class="order-7 dropdown dropdown-end shrink-0" x-ref="cmpMenu" x-show="comparePicker">
                ...
                <div class="order-8 join shrink-0" x-show="read && viewModes.length > 0">
                ...
                <button x-show="copyable !== null" @click="$clip(copyable)" :title="copyTitle"
                        class="order-9 btn btn-xs btn-square btn-ghost shrink-0">
                  <i class="ph ph-copy text-sm"></i></button>
                <button x-show="!!action" @click="action && action.onClick(path)"
                        :title="action?.label"
                        class="order-10 btn btn-xs btn-square btn-ghost shrink-0">
