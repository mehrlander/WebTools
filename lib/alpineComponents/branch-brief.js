    ...
    return {
      ...
      template: `
        <!-- The layout, and the one thing it decides: WHERE the scrollbar is.
             ...
             STANDALONE BELOW lg, it is a page and scrolls as one, because a
             ...
             STANDALONE AT lg AND UP, it is locked to the viewport and the two
        ...
        <div class="mx-auto w-full flex flex-col p-4 gap-4"
             :class="framed ? 'h-full min-h-0 pb-0' : 'lg:h-full lg:min-h-0'">
          ...
          <!-- The sections, files first; the heading row above carries why.
               ...
               it. Locked (lg, standalone) it scrolls nothing itself: it is the
               box the two sections divide, and each owns a scrollbar. -->
          <div class="flex flex-col gap-4"
               :class="framed ? 'flex-1 min-h-0 overflow-y-auto pb-4' : 'lg:flex-1 lg:min-h-0'">
            ...
            <div x-ref="files" x-show="!loading" class="flex flex-col gap-1.5"
                 :class="!framed && 'lg:min-h-0 lg:max-h-[45%]'">
              ...
              <div x-ref="fileList" x-show="!!brief?.files.length && !filesLoading"
                   ...
                   :class="!framed && 'lg:min-h-0 lg:overflow-y-auto'">
                ...
                <div x-show="!!(verdict || scanLoading || scanError)"
                     ...
                     :class="!framed && 'lg:sticky lg:top-0 lg:z-10 lg:bg-base-200'">
            ...
            <div x-ref="guide" x-show="!loading" class="flex flex-col gap-4"
                 :class="!framed && 'lg:min-h-0 lg:grow lg:overflow-y-auto'">
