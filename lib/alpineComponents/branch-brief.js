          ...
          <template x-if="brief && !loading">
            <div class="flex flex-col gap-4">
              ...
              <div class="flex flex-wrap items-baseline gap-x-5 gap-y-1.5 text-sm
                ...
                <span class="whitespace-nowrap">
                  <span class="opacity-55">files</span>
                  <span class="font-mono font-medium" x-text="brief.files.length"></span>
                  <span class="opacity-45 text-xs" x-show="!brief.complete">capped</span>
                </span>
              </div>
              ...
              <div x-show="brief.files.length" class="flex flex-col gap-1.5">
                <div class="flex items-baseline gap-2">
                  <span class="text-xs uppercase tracking-wide opacity-60"
                        x-text="plural(brief.files.length, 'changed file')"></span>
