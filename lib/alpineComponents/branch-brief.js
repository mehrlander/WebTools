          ...
          <template x-if="brief && !loading">
            <div class="flex flex-col gap-4">
              ...
              <div class="flex items-center gap-2">
                ...
                <a :href="dropUrl" target="_blank" rel="noopener" class="btn btn-sm btn-square btn-ghost"
                   title="Drop a file onto this branch (GitHub's new-file form, name prefilled)">
                  <i class="ph ph-tray-arrow-down"></i></a>
              </div>
