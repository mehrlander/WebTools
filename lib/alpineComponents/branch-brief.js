        ...
        <div class="mx-auto w-full flex flex-col px-4 pt-3 pb-4 gap-2"
          ...
          <div class="flex flex-col gap-2"
            ...
            <!-- CLIPPED TO ITS HEAD, with the page's one expander, because
                 ...
                 list left. Being first is what keeps it reachable now, so the
                 pane and the second page-level scrollbar are both gone. See the
                 container note above.
                 (No backticks in this markup: it is a JS template literal.) -->
            <div x-ref="guide" x-show="!loading" class="relative flex flex-col gap-1">
             <div class="flex flex-col gap-3 overflow-y-auto rounded-lg"
