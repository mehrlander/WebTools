...
// is the expensive read, and only the Files and Commits panes need it, so a
// host that lends the head's numbers gets a view that renders the guide on the
// pulls call alone and fetches the diff when the reader asks for it.
          ...
          <div class="shrink-0 flex flex-col gap-4">
            ...
            <div class="flex items-center gap-2">
              <div role="tablist" class="tabs tabs-box tabs-sm flex-nowrap bg-base-200 p-0.5 min-w-0">
                ...
                <!-- Both of these panes are the compare's, so tapping one is
                     what ASKS for it. The counts stay blank until it lands
                     rather than reading 0, which a branch with no changed
                     files would also read. -->
                ...
                <a role="tab" class="tab gap-1 flex-nowrap whitespace-nowrap" :class="pane === 'commits' && 'tab-active'"
                   @click="pane = 'commits'; ensureCompare()">
