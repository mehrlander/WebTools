      ...
      template: `
        ...
        <div class="mx-auto w-full flex flex-col px-4 pt-3 pb-4 gap-2"
          ...
          <div x-show="!loading && reviewableFiles.length > 0"
               class="shrink-0 flex flex-col gap-1.5"
               :class="!framed && 'roomy:min-h-0 roomy:max-h-[33%] roomy:overflow-y-auto'">
            <div class="flex items-baseline gap-1.5 px-0.5 min-w-0">
              <span class="text-sm font-medium shrink-0">Reviewable</span>
              <span class="font-mono text-sm opacity-45 shrink-0" x-text="reviewableFiles.length"></span>
              <span class="text-xs opacity-40 truncate">html and markdown</span>
            </div>
