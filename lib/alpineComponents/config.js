              ...
              <div class="flex flex-col gap-2">
                ...
                <template x-for="row in projectRows" :key="row.path">
                  <div class="rounded-lg border p-2.5 flex flex-col gap-2"
                    ...
                    <div x-show="row.declared" class="flex gap-2 flex-wrap">
                      <label class="flex flex-col gap-1 flex-1 min-w-[8rem]">
                        ...
                        <input :value="row.label" @input="setProjField(row.path, 'label', $event.target.value)"
                               ...
                               autocapitalize="off" autocorrect="off" spellcheck="false"
                               class="input input-bordered input-xs text-base">
                      </label>
                      <label class="flex flex-col gap-1 flex-1 min-w-[12rem]">
                        ...
                        <input :value="row.landing" @input="setProjField(row.path, 'landing', $event.target.value)"
                               ...
                               autocapitalize="off" autocorrect="off" spellcheck="false"
                               class="input input-bordered input-xs font-mono text-base">
                      </label>
                      <label class="flex flex-col gap-1 flex-1 min-w-[12rem]">
                      ...
                      <label class="flex items-center gap-1.5 cursor-pointer self-end pb-1.5"
                        ...
                        <input type="checkbox" class="checkbox checkbox-xs"
                               ...
                               @change="setProjField(row.path, 'tracker', $event.target.checked ? false : '')">
                        <span class="text-sm text-base-content/50">No board</span>
                      </label>
                    </div>
                  </div>
                </template>
