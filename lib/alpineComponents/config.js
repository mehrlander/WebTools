      ...
      template: `
        <div class="flex flex-col gap-4">
          ...
          <p x-show="!authed" class="text-base text-base-content/60">
            Editing needs a token: set one on the Repos dashboard. The config still reads below.
          </p>
            ...
            <div class="@container flex-col gap-5 lg:flex lg:flex-[3] lg:min-w-0"
              ...
              <section class="flex flex-col gap-2">
                ...
                <div class="rounded-lg border border-base-300 p-3 grid gap-3 @md:grid-cols-6">
                  ...
                  <label class="flex flex-col gap-1 min-w-0 @md:col-span-6">
                    <span class="text-sm font-medium text-base-content/60">Scope
                      <span class="font-normal text-base-content/40">(headlines the Map card)</span></span>
              ...
              <section class="flex flex-col gap-2">
                <div class="flex items-center gap-2 flex-wrap">
                  ...
                  <span class="text-sm text-base-content/40"
                        x-text="declaredProjects.length ? declaredProjects.length + ' declared' : 'none declared'"></span>
                  <div class="grow"></div>
                ...
                <p x-show="!projectRows.length" class="text-sm text-base-content/40"
                   x-text="scanned ? 'No workspace here carries a tracker, and none is declared.'
                                   : 'None declared. Scan to find workspaces carrying a tracker.'"></p>
              ...
              <section class="flex flex-col gap-2">
                ...
                <p x-show="!pageRows.length" class="text-sm text-base-content/40">
                  No catalog. A repo with pages declared here gets the gallery instead of a synthesized overview.
                </p>
                  ...
                  <div class="rounded-lg border border-base-300 p-2.5 flex flex-col gap-2">
                    ...
                    <div class="grid gap-2 @xl:grid-cols-3">
                      ...
                      <label class="flex flex-col gap-1 min-w-0 @xl:col-span-2">
                        ...
                        <input :value="row.note" @input="setPageField(i, 'note', $event.target.value)"
              ...
              <section class="flex flex-col gap-2">
                <div class="flex items-center gap-2 flex-wrap">
                  ...
                  <span class="text-sm text-base-content/40">what this repo offers to move</span>
                </div>
                <div class="rounded-lg border border-base-300 p-3 grid gap-3 @md:grid-cols-2">
                  <label class="flex flex-col gap-1 min-w-0">
                    ...
                    <textarea x-model="stageFilesText" rows="3" spellcheck="false"
                              ...
                              class="textarea textarea-bordered font-mono text-base leading-snug w-full"></textarea>
                    <span class="text-sm text-base-content/40">Seeded into the stage only when it is empty, so a working set you built wins.</span>
                  </label>
                  <label class="flex flex-col gap-1 min-w-0">
                    ...
                    <textarea x-model="stageTargetsText" rows="3" spellcheck="false"
                              ...
                              class="textarea textarea-bordered font-mono text-base leading-snug w-full"></textarea>
                    <span class="text-sm text-base-content/40">Offered as destinations in Copy-to-repo.</span>
                  </label>
                </div>
              </section>

              <p class="text-sm text-base-content/40">
                Every field is here except a page's icon, thumb, project, and app-view label, and the
                <span class="font-mono">links</span> board path. Those are preserved on save; edit them in the JSON pane.
              </p>
            </div>

            <!-- JSON: the whole file. A JSON edit re-parses into the form. -->
            <!-- The JSON pane takes the smaller share (2 of 5): it is a mirror
                 of the form, and the form is what people came to use. -->
            <div class="flex-col gap-1 lg:flex lg:flex-[2] lg:min-w-0"
          ...
          <div x-show="!loading" class="flex items-center gap-2 pt-1">
            ...
            <span x-show="!authed" class="text-sm text-base-content/50">Sign in (a token, on Repos) to save.</span>
          </div>
        </div>`,
