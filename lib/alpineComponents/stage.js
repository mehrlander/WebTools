...
window.StageIntake = (() => {
  ...
  return { take, takeFile, takeDrop, focus, keyOf, textItem,
           flavorsOf, nameForFlavor, nameForText, isDelimited, textFromBytes };
})();
...
document.addEventListener('alpine:init', function() {
  Alpine.data('stager', function() {
    ...
    const { take, takeFile, takeDrop, keyOf, textItem, flavorsOf, nameForFlavor } = window.StageIntake;
