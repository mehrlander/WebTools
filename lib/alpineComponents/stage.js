            ...
            <div class="flex flex-col gap-3 min-w-0">
              ...
              <div class="flex flex-col gap-1.5">
                ...
                <div x-show="dictOpen" x-cloak
                  ...
                  <div class="min-h-[3.5rem] max-h-40 overflow-y-auto text-base leading-relaxed px-1">
                  ...
                  <div class="flex items-center gap-2">
                    <button @click="dictToggle()" class="btn btn-sm btn-square"
                    ...
                    <label class="flex items-center gap-1.5 text-base cursor-pointer"
                           :class="dictBreaks ? '' : 'opacity-60'"
                           title="Break into paragraphs where you paused longest">
                      <input type="checkbox" x-model="dictBreaks" class="checkbox checkbox-sm">
                      <span>Breaks</span>
                    </label>
                    <div class="grow"></div>
                    <button @click="dictStage()" :disabled="!dictText && !dictInterim"
