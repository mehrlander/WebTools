          ...
          <div class="grid gap-4 items-start lg:grid-cols-[minmax(0,1fr)_20rem]">
            ...
            <div class="flex flex-col gap-3 min-w-0">
              ...
              <div x-show="items.length" class="flex flex-col gap-1.5">
                <!-- The label row carries the set's own actions: a link is the
                     set serialized, a sweep is the set emptied. Both act on
                     exactly the list beneath them, where the per-item x already
                     removes one. -->
