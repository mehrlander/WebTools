            ...
            <div class="flex flex-col gap-3 min-w-0">
              ...
              <div class="flex flex-col gap-1.5">
                ...
                <div class="flex items-center gap-1 text-base font-semibold uppercase tracking-wide text-base-content/40">
                  ...
                  <button @click="$refs.fileInput.click()" class="btn btn-square btn-ghost hover:text-primary"
                          title="Attach a local file (or drop one anywhere on this view)">
                    <i class="ph ph-paperclip text-xl"></i>
                  </button>
                  <button @click="pasteIn()" class="btn btn-square btn-ghost hover:text-primary"
                  ...
                  <button @click="copyLink()" :disabled="!items.length" class="btn btn-square btn-ghost hover:text-primary"
                  ...
                  <button @click="openSave()" :disabled="!items.length" class="btn btn-square btn-ghost hover:text-primary"
                          title="Save this set as a surface, kept alongside the others">
                    <i class="ph ph-push-pin text-xl"></i>
                  </button>
                  <button @click="clearAll()" :disabled="!items.length" class="btn btn-square btn-ghost hover:text-error" title="Clear the stage">
                ...
                <div x-show="dictOpen" x-cloak data-no-swipe
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <div class="grow"></div>
                    <button @click="dictStage()" :disabled="!dictText && !dictInterim && !dictDraft.trim()"
