...
// one thing, what a missing `@ref` means (tracker task
// one-repo-address-parser-5gtv92). This module is the answer that copy should
// converge on; the copies still stand, and delegating them is mechanical work
// left to that task.
//
...
// late.
//
// Attaches to window.RepoAddress, loaded via gh.load('repo-address.js').
(() => {
