...
(() => {
  ...
  //
  // Delegates to lib/repo-address.js, which owns the grammar and the ref rule
  ...
  function parseSpec(spec) {
    if (!window.RepoAddress) throw new Error('shorter-payload.js requires window.RepoAddress (load repo-address.js first)');
